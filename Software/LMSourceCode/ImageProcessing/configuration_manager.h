...
namespace golf_sim {
    ...
    class ConfigurationManager {
       public:
         ...
         */
        bool ExportEffectiveConfig(const std::string& output_file,
       ...
       private:
         ...
         */
        template <typename T>
        std::optional<T> GetFromTree(const boost::property_tree::ptree& tree,
         ...
         */
        template <typename T>
        void SetInTree(boost::property_tree::ptree& tree, const std::string& path,
                       const T& value) const;
    };
    ...
    template <typename T>
    std::optional<T> ConfigurationManager::GetFromTree(const boost::property_tree::ptree& tree,
                                                       const std::string& path) const {
        try {
    ...
    template <typename T>
    void ConfigurationManager::SetInTree(boost::property_tree::ptree& tree, const std::string& path,
                                         const T& value) const {
        tree.put(path, value);
    }
