...
namespace golf_sim {
    ...
    void GolfSimClubs::SetCurrentClubType(GsClubType club_type) {
        ...
        GS_LOG_MSG(
            info, "Club type set to " + std::string((club_type == GolfSimClubs::GsClubType::kPutter)
                                                        ? "Putter"
                                                        : "Driver"));
        ...
        std::string club_name =
            (club_type == GolfSimClubs::GsClubType::kPutter) ? "Putter" : "Driver";
        std::string json =
            "{\"result_type\":" + std::to_string(static_cast<int>(GsIPCResultType::kHit)) +
