...
namespace golf_sim {
    ...
    class GsIPCResult {
       ...
       public:
        ...
        int confidence_ =
            0;  // 10 - the results are as confident as the system can be.  0 - no confidence at
                // all.  Probably an error occrued. Not fully implemented yet.
        ...
        MSGPACK_DEFINE(carry_meters_, speed_mpers_, launch_angle_deg_, side_angle_deg_,
                       back_spin_rpm_, side_spin_rpm_, confidence_, club_type_, result_type_,
                       message_, log_messages_, image_file_paths_);
    };
