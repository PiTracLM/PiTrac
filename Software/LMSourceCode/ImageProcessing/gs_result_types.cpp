...
namespace golf_sim {
    ...
    std::string GsIPCResult::Format() const {
        ...
        std::string s = "GsIPCResult:  Carry: " + std::to_string(carry_yards) + " yards.\n" +
                        ...
                        "       Launch Angle: " + std::to_string(launch_angle_deg_) +
                        " degrees.\n" + "         Side Angle: " + std::to_string(side_angle_deg_) +
                        " degrees.\n" + "          Back Spin: " + std::to_string(back_spin_rpm_) +
                        " rpm.\n" + "          Side Spin: " + std::to_string(side_spin_rpm_) +
                        " rpm.\n" + "         Confidence: " + std::to_string(confidence_) +
