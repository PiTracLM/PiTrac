...
void EDColor::ComputeGradientMapByDiZenzo() {
    ...
    for (int i = 1; i < height - 1; i++) {
        for (int j = 1; j < width - 1; j++) {
            ...
            int gyCh1 =
                com1 - com2 + (smooth_L[(i + 1) * width + j] - smooth_L[(i - 1) * width + j]);
            ...
            int gyCh2 =
                com1 - com2 + (smooth_a[(i + 1) * width + j] - smooth_a[(i - 1) * width + j]);
            ...
            int gyCh3 =
                com1 - com2 + (smooth_b[(i + 1) * width + j] - smooth_b[(i - 1) * width + j]);
#else
            // Sobel for channel1
            int com1 = smooth_L[(i + 1) * width + j + 1] - smooth_L[(i - 1) * width + j - 1];
            int com2 = smooth_L[(i - 1) * width + j + 1] - smooth_L[(i + 1) * width + j - 1];
            ...
            int gxCh1 =
                com1 + com2 + 2 * (smooth_L[i * width + j + 1] - smooth_L[i * width + j - 1]);
            int gyCh1 =
                com1 - com2 + 2 * (smooth_L[(i + 1) * width + j] - smooth_L[(i - 1) * width + j]);
            ...
            int gxCh2 =
                com1 + com2 + 2 * (smooth_a[i * width + j + 1] - smooth_a[i * width + j - 1]);
            int gyCh2 =
                com1 - com2 + 2 * (smooth_a[(i + 1) * width + j] - smooth_a[(i - 1) * width + j]);
            ...
            int gxCh3 =
                com1 + com2 + 2 * (smooth_b[i * width + j + 1] - smooth_b[i * width + j - 1]);
            int gyCh3 =
                com1 - com2 + 2 * (smooth_b[(i + 1) * width + j] - smooth_b[(i - 1) * width + j]);
#endif
            ...
            int grad =
                (int)(sqrt(((gxx + gyy) + (gxx - gyy) * cos(2 * theta) + 2 * gxy * sin(2 * theta)) /
                           2.0) +
            ...
            int grad = (int)(sqrt(gxx * cosTheta * cosTheta + 2 * gxy * sinTheta * cosTheta +
...
//--------------------------------------------------------------------------------------------------------------------
// Validate the edge segments using the Helmholtz principle (for color images) channel1, channel2
// and channel3 images
//
void EDColor::validateEdgeSegments() {
    ...
    for (int i = 1; i < height - 1; i++) {
        for (int j = 1; j < width - 1; j++) {
            ...
            int gxCh1 =
                abs(com1 + com2 + (smooth_L[i * width + j + 1] - smooth_L[i * width + j - 1]));
            int gyCh1 =
                abs(com1 - com2 + (smooth_L[(i + 1) * width + j] - smooth_L[(i - 1) * width + j]));
            ...
            int gxCh2 =
                abs(com1 + com2 + (smooth_a[i * width + j + 1] - smooth_a[i * width + j - 1]));
            int gyCh2 =
                abs(com1 - com2 + (smooth_a[(i + 1) * width + j] - smooth_a[(i - 1) * width + j]));
            ...
            int gxCh3 =
                abs(com1 + com2 + (smooth_b[i * width + j + 1] - smooth_b[i * width + j - 1]));
            int gyCh3 =
                abs(com1 - com2 + (smooth_b[(i + 1) * width + j] - smooth_b[(i - 1) * width + j]));
