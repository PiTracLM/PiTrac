    ...
    class PulseStrobe {
       ...
       public:
        ...
        static char* BuildPulseTrain(const unsigned long baud_rate,
                                     ...
                                     const unsigned int kBitsPerWord, unsigned long& result_length,
        ...
        static bool SendSpiMsg(const unsigned int baud, const unsigned long repeats, char* buf,
                               int bufferLength);
       ...
       protected:
        ...
        static char* no_pulse_camera_sequence_;  // Will be all 0's, but the same length as the
                                                 // 'real' pulse sequence
