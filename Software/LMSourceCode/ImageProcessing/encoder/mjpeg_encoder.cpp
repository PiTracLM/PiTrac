...
void MjpegEncoder::EncodeBuffer(int fd, size_t size, void* mem, StreamInfo const& info,
...
void MjpegEncoder::encodeThread(int num) {
    ...
    while (true) {
        ...
        // encode process.
        OutputItem output_item = {encoded_buffer, buffer_len, encode_item.timestamp_us,
                                  encode_item.index};
