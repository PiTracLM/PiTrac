...
// Can be useful for things like specifying a particular aspect of a shot result to use (or ignore)
// when averaging ball flight results.
...
namespace golf_sim {
    ...
    class GsShotParameters {
       public:
        ...
        enum ShotParameter { kShotParameterNone, kBallVelocity, kHLA, kVLA, kShotParameterAll };
