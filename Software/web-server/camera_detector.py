...
class CameraDetector:
    ...
    def get_camera_types(self) -> List[Dict]:
        ...
        return [
            {"value": 1, "label": "Pi Camera v1.3", "description": "OV5647 sensor (DEPRECATED)", "status": "deprecated"},
            {"value": 2, "label": "Pi Camera v2", "description": "IMX219 sensor (DEPRECATED)", "status": "deprecated"},
            {"value": 3, "label": "Pi HQ Camera", "description": "IMX477 sensor (DEPRECATED)", "status": "deprecated"},
            {"value": 4, "label": "Pi Global Shutter", "description": "IMX296 Color (RECOMMENDED)", "status": "supported"},
            {"value": 5, "label": "InnoMaker IMX296", "description": "IMX296 Mono", "status": "supported"}
        ]
        ...
        for path in config_paths:
            if Path(path).exists():
                try:
                    ...
                    diag["config_files"][path] = {"exists": True, "error": "Could not read"}
            else:
