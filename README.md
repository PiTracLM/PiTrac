...
## [Join the Discord](https://discord.gg/EUFQqC6c) (`https://discord.gg/EUFQqC6c`)
The PiTrac discord is where you can get help or show off your PiTrac build, discuss features and get to know other PiTrac builders. PiTrac is still a new project, so the Discord is a way to clear up any fuzzy parts of the initial ecosystem.